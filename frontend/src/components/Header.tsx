        ...
        {isLoading ? (
          ...
          <>
            <div className='desktop-items'>
              {isAdmin && (
                <Link to="/admin" className='header-icon-button'>
              ...
              <Link to="/rating"  className='header-icon-button'>
                ...
                <path d="M9 5H15V15H9V5Z" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M3.5 9H9V15H3.5V9Z" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M15 11H20.5V15H15V11Z" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M3.5 15H20.5V19H3.5V15Z" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </Link>

              <button onClick={handleLogout}  className='header-icon-button'>
                <svg width="24" height="24"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`mobile-items ${isMobileMenuOpen ? 'open' : ''}`}>
              <Link to="/profile" className='nav-link'  onClick={toggleMobileMenu}>Профиль</Link>
              <Link to="/settings" className='nav-link' onClick={toggleMobileMenu}>Настройки</Link>
              <Link to="/rating" className="nav-link" onClick={toggleMobileMenu}>Рейтинг</Link>
              {isAdmin && (
                <Link to="/admin" className="nav-link" onClick={toggleMobileMenu}>Админка</Link>
              )}
              <button onClick={handleLogout} className='nav-link logout'>Выход</button>
            </div>
